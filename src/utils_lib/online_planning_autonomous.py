...
class StateValidityChecker:
    ...
    # Constructor
    def __init__(self, distance=0.21, is_unknown_valid=True): ## 0.2, 0.3 for buffle  
...
def move_to_point(current, goal, imu_angle, Kv=0.5, Kw=0.5):
    ...
    angle = wrap_angle(math.atan2(dy, dx) - imu_angle[2])
...
def move_to_point_goal(current, goal, imu_angle, Kv=0.5, Kw=0.5):
